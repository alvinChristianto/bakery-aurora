...
export default function Hero() {
  ...
  return (
    <section className="mesh-grey grain relative isolate flex min-h-screen items-center overflow-hidden px-6 pb-20 pt-32">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-6xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <div className="text-center lg:text-left">
          ...
          <motion.h1
            ...
            initial="hidden"
            animate="show"
            className="mt-6 text-balance text-5xl font-bold leading-[1.02] text-white sm:text-6xl xl:text-7xl"
          >
            {headline.map((w, i) => (
          ...
          <motion.p
            ...
            className="mx-auto mt-6 max-w-xl text-pretty text-base text-white/70 sm:text-lg lg:mx-0"
          >
